...
class Store(object):
    ...
    def find_by_url(cls, url):
        """
        Return a store from a url like "http://www.johnlewis.com/item/asdf3r23f32f.html"
        ...
        for i in range(0, len(url) + 1):
            try:
                ...
                raise StoreErrors.StoreNotFoundException("The URL prefix used to find the store didn't have any results")
