...
class User(object):
    ...
    def is_login_valid(email, password):
        ...
        user_data = Database.find_one(UserConstants.COLLECTION, {"email": email}) # Password in shar512 -> pbkdf2_sha512
    ...
    def register_user(email, password):
        ...
        :return: True if registered successfully, or False otherwise (exceptions can also raised)
        """
        ...
        if not Utils.email_is_valid(email):
            # Tell user that thir email is not constructed properly
